            ...
            <div class="col-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <input type="text" name="examname" id="category" class="form-control" placeholder="" aria-describedby="helpId">
                        </div>
                        <div class="form-group">
                        <label for="">Exam Time In Minutes</label>
                        <input type="text" name="examtime" class="form-control" placeholder="" aria-describedby="helpId">
                        </div>
                        <div class="form-group">
                        <input type="submit" name="submit1" id="submit" value="Add Exam" class="btn btn-primary" placeholder="" aria-describedby="helpId">
                        </div>
                    </div>
                    </form>
                </div>
